...
![logo](beta_dist.jpg){width=72%}

```{r}
# When in export mode the little dots are unaligned, so fix that. 
if(PDF_EXPORT){
  cat("View this CV online with links at _LinTian.me/cv_")
} else {
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/lintian0616/cv/raw/master/strayer_cv.pdf)")
}
```
...
- <i class="fa fa-envelope"></i> lintian0616@gmail.com
- <i class="fa fa-twitter"></i> sjtubiolin
- <i class="fa fa-github"></i> github.com/lintian0616
- <i class="fa fa-phone"></i> (713) 815-0518
